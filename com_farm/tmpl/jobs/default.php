						...
						foreach ($this->items as $i => $item) :
                            ...
                            <tr class="row<?php echo $i % 2; ?>">
                                <th scope="row" class="has-context">
                                    ...
                                    <a class="hasTooltip" href="<?php echo Route::_('index.php?option=com_farm&task=job.edit&id=' . (int) $item->id); ?>" title="<?php echo Text::_('JACTION_EDIT'); ?> <?php echo $this->escape(addslashes($item->id)); ?>">
